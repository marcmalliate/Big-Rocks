      ...
      <main>
        <div className="getin-background">
          <div className="getin-para flex-row justify-center">
            ...
            <br></br>
            <br></br>- “Every action you take is a vote for the type of person
            you wish to become. <br></br>
            No single instance will transform your beliefs, but as the votes
            build up, <br></br>
            so does the evidence of your new identity.”<br></br>
            James Clear - Atomic Habits<br></br>
            <br></br>
            <br></br>- You are 42% more likely to achieve your goals if you
            write them down.
            <br></br>
            <br></br>
